...
class ChatViewController: UIViewController {
    ...
    var messages: [Message] = [
        Message(sender: "1@2.com", body: "Hey!", date: Date().timeIntervalSince1970),
        Message(sender: "a@b.com", body: "Hello!", date: Date().timeIntervalSince1970),
        Message(sender: "1@2.com", body: "What's up?", date: Date().timeIntervalSince1970)
    ]
